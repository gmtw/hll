...
module globals
  ...
  real, parameter :: rhol=10.0/10.
  real, parameter :: rhor=1.0/10.
  real, parameter :: pl=40./3.0
  real, parameter :: pr=20.0
  real, parameter :: vl=0.
  real, parameter :: vr=0.
...
subroutine ulax(dt,time)
  ...
  real :: up(nequ,0:nx+1), f(nequ,0:nx+1)
  real :: dtx
  integer :: i

  !  obtain the fluxes
  call fluxes(nx,nequ,gamma,u,f)
...
subroutine fluxes(nx,nequ,gamma,u,f)
  !use globals
  implicit none
